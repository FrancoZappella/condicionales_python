...
print(f'El resultado de res_1 es : {res_1}')
...
print(f'El resultado de res_2 es {res_2}')
...
print(f'El resultado de res_3 es : {res_3}')
...
res_4 = 0
if numero_1 < 100 or numero_2 > -2:
    res_4 = 1
else:
    res_4 = 2

# Imprimir en pantalla la variable res_4
print(f'el resultado de res_4 es : {res_4}')