...
print(pregunta_1)
respuesta_usuario_1 = input().lower()
if respuesta_usuario_1 == respuesta_1:
    puntaje += 10

# Pregunta 2
print(pregunta_2)
respuesta_usuario_2 = input().lower()
if respuesta_usuario_2 == respuesta_2:
    puntaje += 10

# Pregunta 3
print(pregunta_3)
respuesta_usuario_3 = input().lower()
if respuesta_usuario_3 == respuesta_3:
    puntaje += 10
print(pregunta_4)
respuesta_usuario_4 = input().lower()
if respuesta_usuario_4 == respuesta_4:
    puntaje += 10

# Pregunta 5
print(pregunta_5)
respuesta_usuario_5 = input().lower()
